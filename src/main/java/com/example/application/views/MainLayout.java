...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Gestion De Citas");
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(new SideNavItem("Paciente", PacienteView.class, LineAwesomeIcon.USER.create()));
        nav.addItem(new SideNavItem("Crear Cita", CrearCitaView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
        nav.addItem(new SideNavItem("Ver Citas", VerCitasView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
